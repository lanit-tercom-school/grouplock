...
class EncryptedFilePresenterTests: XCTestCase {
    ...
    struct Seeds {
        ...
        struct Fetch {
            ...
            static let viewModelForCorrectData = EncryptedFile.Fetch.ViewModel(fileInfo: fileInfoForCorrectContents)
            ...
            static let viewModelForIncorrectData = EncryptedFile.Fetch.ViewModel(fileInfo: fileInfoForIncorrectContents)
        }
    }
